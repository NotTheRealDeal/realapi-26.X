...
public class RealAPIClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ContainerScreenEvents.SLOT_MOUSE_ACTION.register((_, consumer) -> consumer.accept(new BundleLikeMouseActions()));
        ...
        ItemComponentTooltipProviderRegistry.addAfter(DataComponents.UNBREAKABLE, RealDataComponents.KEEP_ON_DEATH);
    }
}